...
namespace Blaga_Teodora_Lab2.Data
{
    public class Blaga_Teodora_Lab2Context : DbContext
    {
        ...
        public DbSet<Blaga_Teodora_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Blaga_Teodora_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Blaga_Teodora_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
