...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blaga_Teodora_Lab2.Models.Borrowing", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Blaga_Teodora_Lab2.Models.Member", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Blaga_Teodora_Lab2.Models.Book", b =>
                {
                    b.HasOne("Blaga_Teodora_Lab2.Models.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorID");

                    b.HasOne("Blaga_Teodora_Lab2.Models.Publisher", "Publisher")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Blaga_Teodora_Lab2.Models.Borrowing", b =>
                {
                    ...
                    b.HasOne("Blaga_Teodora_Lab2.Models.Member", "Member")
                        .WithMany("Borrowings")
